...
tiene_credencial = input('¿Usted cuenta con la credencial de la biblioteca? (si/no): ') # Consultamos si el usuario tiene credencial.
...
prestamo_libro = (tiene_credencial.strip().lower() == 'si') or (cantidad_kilometros <= LIMITE_DISTANCIA) # Usamos el operador OR para comparar los valores y determinar si alguno de los dos es verdadero o si ninguno lo es. 
